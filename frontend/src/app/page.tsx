...
export default function HomePage() {
    ...
    return (
      <div className="flex min-h-[50vh] items-center justify-center">
        <div className="text-center">
          ...
          <p className="mt-2 text-sm text-ink-muted">Loading your assignments...</p>
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="relative mx-auto max-w-5xl px-4 py-6 sm:px-6 sm:py-8">
      {/* Page heading */}
      <div className="mb-1">
        <h1 className="text-2xl font-bold text-ink-main">Assignments</h1>
        <p className="mt-0.5 text-sm text-ink-muted">
          Assign and create assignments for your classes.
        </p>
      </div>
